    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AppYoutube.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://www.youtube.com/channel/UC-hM6YJuNYVAmUWxeIr9FeA"));
                startActivity(i);
            }
        });
        ...
        AppDownload.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(android.content.Intent.ACTION_VIEW);
                i.setData(Uri.parse("https://drive.google.com/drive/folders/1zdnd9tFacG4XDLuwubhIwpHXw2xKpLIs?usp=sharing"));
                startActivity(i);
            }
        });
